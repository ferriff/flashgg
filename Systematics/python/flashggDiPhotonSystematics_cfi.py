...
mvaLinearSystBins = cms.PSet(
    variables = cms.vstring("abs(photon.superCluster.eta)", "phoIdMvaWrtChosenVtx"),
    bins = cms.VPSet(
        cms.PSet( lowBounds = cms.vdouble(0.0, -1.0), upBounds = cms.vdouble(1.5, -0.98), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.170, 1.000 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.98), upBounds = cms.vdouble(1.5, -0.96), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.170, 1.000 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.96), upBounds = cms.vdouble(1.5, -0.94), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.170, 1.000 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.94), upBounds = cms.vdouble(1.5, -0.92), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.170, 1.000 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.92), upBounds = cms.vdouble(1.5, -0.9), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.170, 1.000 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.9), upBounds = cms.vdouble(1.5, -0.88), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.170, 1.000 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.88), upBounds = cms.vdouble(1.5, -0.86), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.011, 0.988 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.86), upBounds = cms.vdouble(1.5, -0.84), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.011, 0.956 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.84), upBounds = cms.vdouble(1.5, -0.82), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.088, 0.939 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.82), upBounds = cms.vdouble(1.5, -0.8), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.095, 0.921 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.8), upBounds = cms.vdouble(1.5, -0.78), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.944, 0.911 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.78), upBounds = cms.vdouble(1.5, -0.76), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.906, 0.886 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.76), upBounds = cms.vdouble(1.5, -0.74), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.898, 0.866 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.74), upBounds = cms.vdouble(1.5, -0.72), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.980, 0.847 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.72), upBounds = cms.vdouble(1.5, -0.7), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.887, 0.835 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.7), upBounds = cms.vdouble(1.5, -0.68), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.842, 0.823 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.68), upBounds = cms.vdouble(1.5, -0.66), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.854, 0.797 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.66), upBounds = cms.vdouble(1.5, -0.64), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.779, 0.783 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.64), upBounds = cms.vdouble(1.5, -0.62), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.906, 0.755 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.62), upBounds = cms.vdouble(1.5, -0.6), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.816, 0.747 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.6), upBounds = cms.vdouble(1.5, -0.58), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.788, 0.737 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.58), upBounds = cms.vdouble(1.5, -0.56), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.749, 0.716 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.56), upBounds = cms.vdouble(1.5, -0.54), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.696, 0.703 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.54), upBounds = cms.vdouble(1.5, -0.52), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.811, 0.668 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.52), upBounds = cms.vdouble(1.5, -0.5), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.710, 0.655 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.5), upBounds = cms.vdouble(1.5, -0.48), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.712, 0.655 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.48), upBounds = cms.vdouble(1.5, -0.46), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.774, 0.616 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.46), upBounds = cms.vdouble(1.5, -0.44), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.591, 0.636 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.44), upBounds = cms.vdouble(1.5, -0.42), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.659, 0.580 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.42), upBounds = cms.vdouble(1.5, -0.4), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.735, 0.555 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.4), upBounds = cms.vdouble(1.5, -0.38), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.564, 0.579 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.38), upBounds = cms.vdouble(1.5, -0.36), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.576, 0.544 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.36), upBounds = cms.vdouble(1.5, -0.34), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.565, 0.506 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.34), upBounds = cms.vdouble(1.5, -0.32), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.491, 0.516 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.32), upBounds = cms.vdouble(1.5, -0.3), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.625, 0.465 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.3), upBounds = cms.vdouble(1.5, -0.28), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.455, 0.481 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.28), upBounds = cms.vdouble(1.5, -0.26), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.466, 0.456 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.26), upBounds = cms.vdouble(1.5, -0.24), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.474, 0.420 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.24), upBounds = cms.vdouble(1.5, -0.22), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.500, 0.409 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.22), upBounds = cms.vdouble(1.5, -0.2), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.418, 0.407 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.2), upBounds = cms.vdouble(1.5, -0.18), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.430, 0.379 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.18), upBounds = cms.vdouble(1.5, -0.16), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.369, 0.371 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.16), upBounds = cms.vdouble(1.5, -0.14), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.358, 0.343 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.14), upBounds = cms.vdouble(1.5, -0.12), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.377, 0.313 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.12), upBounds = cms.vdouble(1.5, -0.1), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.340, 0.317 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.1), upBounds = cms.vdouble(1.5, -0.08), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.300, 0.291 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.08), upBounds = cms.vdouble(1.5, -0.06), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.299, 0.273 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.06), upBounds = cms.vdouble(1.5, -0.04), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.287, 0.252 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.04), upBounds = cms.vdouble(1.5, -0.02), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.256, 0.260 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, -0.02), upBounds = cms.vdouble(1.5, 0.0), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.307, 0.207 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, 0.0), upBounds = cms.vdouble(1.5, 0.02), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.243, 0.217 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, 0.02), upBounds = cms.vdouble(1.5, 0.04), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.211, 0.215 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, 0.04), upBounds = cms.vdouble(1.5, 0.06), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.153, 0.181 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, 0.06), upBounds = cms.vdouble(1.5, 0.08), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.161, 0.134 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, 0.08), upBounds = cms.vdouble(1.5, 0.1), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.157, 0.116 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, 0.1), upBounds = cms.vdouble(1.5, 0.12), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.131, 0.123 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, 0.12), upBounds = cms.vdouble(1.5, 0.14), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.109, 0.128 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, 0.14), upBounds = cms.vdouble(1.5, 0.16), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.120, 0.085 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, 0.16), upBounds = cms.vdouble(1.5, 0.18), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.114, 0.073 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, 0.18), upBounds = cms.vdouble(1.5, 0.2), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.070, 0.078 ) ), 
        cms.PSet( lowBounds = cms.vdouble(0.0, 0.2), upBounds = cms.vdouble(1.5, 0.22), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.047, 0.070 ) ), 
        
        cms.PSet( lowBounds = cms.vdouble(1.5, -1.0), upBounds = cms.vdouble(6.0, -0.98), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.052, 1.000 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.98), upBounds = cms.vdouble(6.0, -0.96), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.052, 1.000 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.96), upBounds = cms.vdouble(6.0, -0.94), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.052, 1.000 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.94), upBounds = cms.vdouble(6.0, -0.92), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.052, 1.000 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.92), upBounds = cms.vdouble(6.0, -0.9), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.052, 1.000 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.9), upBounds = cms.vdouble(6.0, -0.88), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.052, 1.000 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.88), upBounds = cms.vdouble(6.0, -0.86), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.167, 0.987 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.86), upBounds = cms.vdouble(6.0, -0.84), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.177, 0.956 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.84), upBounds = cms.vdouble(6.0, -0.82), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.936, 0.946 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.82), upBounds = cms.vdouble(6.0, -0.8), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.033, 0.919 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.8), upBounds = cms.vdouble(6.0, -0.78), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.974, 0.905 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.78), upBounds = cms.vdouble(6.0, -0.76), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.985, 0.887 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.76), upBounds = cms.vdouble(6.0, -0.74), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.884, 0.871 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.74), upBounds = cms.vdouble(6.0, -0.72), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.042, 0.846 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.72), upBounds = cms.vdouble(6.0, -0.7), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.873, 0.838 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.7), upBounds = cms.vdouble(6.0, -0.68), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.815, 0.848 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.68), upBounds = cms.vdouble(6.0, -0.66), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 1.176, 0.794 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.66), upBounds = cms.vdouble(6.0, -0.64), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.990, 0.783 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.64), upBounds = cms.vdouble(6.0, -0.62), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.763, 0.806 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.62), upBounds = cms.vdouble(6.0, -0.6), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.887, 0.740 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.6), upBounds = cms.vdouble(6.0, -0.58), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.724, 0.735 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.58), upBounds = cms.vdouble(6.0, -0.56), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.913, 0.702 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.56), upBounds = cms.vdouble(6.0, -0.54), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.728, 0.715 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.54), upBounds = cms.vdouble(6.0, -0.52), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.714, 0.683 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.52), upBounds = cms.vdouble(6.0, -0.5), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.652, 0.675 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.5), upBounds = cms.vdouble(6.0, -0.48), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.794, 0.627 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.48), upBounds = cms.vdouble(6.0, -0.46), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.609, 0.631 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.46), upBounds = cms.vdouble(6.0, -0.44), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.903, 0.592 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.44), upBounds = cms.vdouble(6.0, -0.42), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.625, 0.622 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.42), upBounds = cms.vdouble(6.0, -0.4), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.576, 0.612 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.4), upBounds = cms.vdouble(6.0, -0.38), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.618, 0.539 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.38), upBounds = cms.vdouble(6.0, -0.36), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.570, 0.538 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.36), upBounds = cms.vdouble(6.0, -0.34), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.528, 0.534 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.34), upBounds = cms.vdouble(6.0, -0.32), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.576, 0.496 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.32), upBounds = cms.vdouble(6.0, -0.3), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.467, 0.491 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.3), upBounds = cms.vdouble(6.0, -0.28), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.651, 0.449 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.28), upBounds = cms.vdouble(6.0, -0.26), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.499, 0.474 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.26), upBounds = cms.vdouble(6.0, -0.24), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.480, 0.439 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.24), upBounds = cms.vdouble(6.0, -0.22), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.451, 0.436 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.22), upBounds = cms.vdouble(6.0, -0.2), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.552, 0.401 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.2), upBounds = cms.vdouble(6.0, -0.18), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.435, 0.421 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.18), upBounds = cms.vdouble(6.0, -0.16), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.363, 0.384 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.16), upBounds = cms.vdouble(6.0, -0.14), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.411, 0.350 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.14), upBounds = cms.vdouble(6.0, -0.12), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.379, 0.336 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.12), upBounds = cms.vdouble(6.0, -0.1), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.296, 0.330 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.1), upBounds = cms.vdouble(6.0, -0.08), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.381, 0.266 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.08), upBounds = cms.vdouble(6.0, -0.06), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.374, 0.283 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.06), upBounds = cms.vdouble(6.0, -0.04), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.253, 0.291 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.04), upBounds = cms.vdouble(6.0, -0.02), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.250, 0.263 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, -0.02), upBounds = cms.vdouble(6.0, 0.0), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.305, 0.193 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, 0.0), upBounds = cms.vdouble(6.0, 0.02), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.249, 0.251 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, 0.02), upBounds = cms.vdouble(6.0, 0.04), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.252, 0.185 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, 0.04), upBounds = cms.vdouble(6.0, 0.06), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.216, 0.194 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, 0.06), upBounds = cms.vdouble(6.0, 0.08), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.126, 0.175 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, 0.08), upBounds = cms.vdouble(6.0, 0.1), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.240, 0.134 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, 0.1), upBounds = cms.vdouble(6.0, 0.12), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.104, 0.162 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, 0.12), upBounds = cms.vdouble(6.0, 0.14), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.136, 0.131 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, 0.14), upBounds = cms.vdouble(6.0, 0.16), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.091, 0.099 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, 0.16), upBounds = cms.vdouble(6.0, 0.18), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.139, 0.083 ) ), 
        cms.PSet( lowBounds = cms.vdouble(1.5, 0.18), upBounds = cms.vdouble(6.0, 0.2), values = cms.vdouble( 1.000 ), uncertainties = cms.vdouble( 0.050, 0.048 ) ),
        )
    )
